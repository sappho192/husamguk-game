...
| 2 | 카드 시스템 | 글로벌 턴에 카드 1장 사용 | 🔲 진행중 (Phase 2) |
| 3 | 내정 연결 | 선택지 3개 → 전투 → 강화 선택 | 🔲 계획됨 (Phase 3) |
| 4 | 런 루프 완성 | 3스테이지 연결 + 게임오버/클리어 조건 | 🔲 계획됨 (Phase 4) |

### 8.2 Phase 1 구현 완료 (2025-01)
...
**목표**: "내정 1회 → 전투 1회" 사이클 구현 (Phase 3에서 진행 예정)
