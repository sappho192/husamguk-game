...
| NPC | 특성 | 제공 테마 | 캐릭터 |
|-----|------|----------|--------|
| 좌자 (Jwaja) | 삼국시대 명의 | 치유, 방어, 지원 | 의사 |
| 화타 (Hwata) | 삼국시대 명의 | 치유, 방어, 지원 | 명의 |
| 우길 (Ugil) | 도교 도사 | 신비, 버프, 속도 | 도사 |
| 남화노선 (Namhwa) | 도교 불사 | 신비, 버프, 속도 | 도교 불사 |
| 수경선생 (Sugyeong) | 전략가 (사마휘) | 전술, 카드, 지휘 | 전략가 |
...
**예시:**
- 좌자/화타 (의사): 방어력 증가, 병력 회복, 피해 감소 강화
- 우길/남화노선 (도사): 이상 현상, 버프 효과, ATB 속도 강화
- 수경선생 (전략가): 카드 효과 증강, 전술적 이점, 지휘 강화
...
**NPC 목록:**
- 좌자 (Jwaja) - 의사: 치유/방어/지원 강화 제공
- 화타 (Hwata) - 명의: 치유/방어/지원 강화 제공
- 우길 (Ugil) - 도사: 신비/버프/속도 강화 제공
- 남화노선 (Namhwa) - 도교 불사: 신비/버프/속도 강화 제공
- 수경선생 (Sugyeong) - 전략가: 전술/카드/지휘 강화 제공
...
### 9.6 Phase 4 목표 (메타 프로그레션)

**계획된 기능:**
- 🔲 SaveManager 구현 (세이브/로드 기능)
- 🔲 메타 프로그레션 잠금 해제 (영구 업그레이드)
- 🔲 스테이지 전반의 적 스케일링
- 🔲 추가 콘텐츠 (더 많은 이벤트, 강화, 카드)
- 🔲 밸런스 조정 및 다듬기
