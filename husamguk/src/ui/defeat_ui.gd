...
func _ready() -> void:
	...
	if GameManager.current_run:
		...
		stages_cleared = run.current_stage - 1  # Failed at current stage, so -1
...
func _set_localized_text() -> void:
	title_label.text = DataManager.get_localized("UI_RUN_DEFEAT")
...
func _create_ui() -> void:
	...
	title_label.add_theme_color_override("font_color", Color(0.9, 0.3, 0.3))  # Red
...
func _add_stat_row(label_text: String, value_text: String) -> void:
	...
	value.add_theme_color_override("font_color", Color(0.9, 0.5, 0.5))  # Light red
...
func _on_return_button_pressed() -> void:
	print("DefeatUI: Returning to main menu...")
